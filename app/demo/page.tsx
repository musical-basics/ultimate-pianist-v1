...
/**
 * Demo Playback — Offline-first, no Supabase needed.
 * Uses hardcoded DEMO_CONFIG + static assets in /public/demo.
 */

import * as React from 'react'
import { useState, useEffect, useCallback, useRef } from 'react'
import { useRouter } from 'next/navigation'
import { Play, Pause, Square, SkipBack, Music2, Palette, Sparkles, BookOpen, Piano } from 'lucide-react'
...
export default function DemoPlayback() {
    ...
    }, [config, setAnchors, setBeatAnchors, setFont])
    ...
    }, [isPlaying, setPlaying, config.audio_url, volume, tempo])
